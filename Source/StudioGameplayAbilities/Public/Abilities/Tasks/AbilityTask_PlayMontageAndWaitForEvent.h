 ...
 */
UCLASS()
class STUDIOGAMEPLAYABILITIES_API UAbilityTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
...
public:
	...
	static UAbilityTask_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
		...
		bool bStopWhenAbilityCancelled = true,
		bool bEndTaskWhenMontageEnded = true,
		bool bAlwaysBroadcastAbilityTaskDelegates = false,
...
private:
	...
	/** Rather montage should be aborted if ability cancelled */
	UPROPERTY()
	bool bStopWhenAbilityCancelled;

	/** Rather montage should be end task when montage ended */
	UPROPERTY()
	bool bEndTaskWhenMontageEnded;

	/** Always broadcast ability task delegates */
	UPROPERTY()
	bool bAlwaysBroadcastAbilityTaskDelegates;
